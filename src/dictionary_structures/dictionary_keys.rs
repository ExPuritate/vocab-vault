...
impl PartOfSpeech {
    ...
    pub fn dict_key_to_part_of_speech(key: &str) -> PartOfSpeech {
        match key.trim_matches('"') {
            ...
            "V" | "verb" => PartOfSpeech::Verb,
            "VPAR" | "participle" => PartOfSpeech::Participle,
            ...
            "NUM" | "numeral" => PartOfSpeech::Numeral,
            "CONJ" | "conjunction" => PartOfSpeech::Conjunction,
            "ADV" | "adverb" => PartOfSpeech::Adverb,
            "INT" | "number" => PartOfSpeech::Number,
            "SUPINE" | "supine" => PartOfSpeech::Supine,
            "PACK" | "packon" => PartOfSpeech::Packon,
            "TACKON" | "tackon" => PartOfSpeech::Tackon,
            "PREFIX" | "prefix" => PartOfSpeech::Prefix,
            "SUFFIX" | "suffix" => PartOfSpeech::Suffix,
